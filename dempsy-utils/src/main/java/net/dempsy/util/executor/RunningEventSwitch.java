 ...
 * be one running at a time. To use it you should instantiate a {@link RunningEventSwitch}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The RunningEventSwitch can also monitor an externally supplied "isRunning" flag
 * so that the job will be 'preempted' whenever that's also set to false
 * </p>
 */
