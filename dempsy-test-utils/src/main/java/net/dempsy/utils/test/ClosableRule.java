...
/**
 * A {@link ClosableRule} can be used to manage resources for unit tests that are {@link AutoCloseable}s.
 * 
 * <pre>
 * {@code
 * @ClassRule
 ...
 * </pre>
 */
public class ClosableRule extends ExternalResource {
    private final AutoCloseable[] autoCloseables;

    private final String newLine = System.getProperty("line.separator");

    public ClosableRule(final AutoCloseable... autoCloseables) {
